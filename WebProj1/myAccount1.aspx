<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="myAccount1.aspx.cs" Inherits="WebProj1.myAccount1" %>
        ...
        <table class="auto-style14">
            ...
            <tr>
                <td class="auto-style39">&nbsp;<br />
                    <br />
                    <asp:Button ID="btnEdit" runat="server" Font-Names="Bahnschrift SemiBold" Font-Size="Large" Height="35px" Text="Edit" Width="120px" CssClass="editbtn" OnClick="btnEdit_Click" />
                </td>
                <td class="auto-style40">
                    <br />
                    <br />
